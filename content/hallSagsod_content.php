    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 doc-sec-text-conteiner">
            <div class="post_content_right_bar width100">
                <h3 class="font-family-gotham specialist-sec-title">Hall Sangsod</h3>
                <div class="post_content_description col-sm-12 col-md-8">
                    <div class="post_content_right_bar width100">
                        <div class="row">
                            <table class="table table-bordered">
                                <tr>
                                    <th class="width4per">S/L</th>
                                    <th class="width20per">Image</th>
                                    <th >Name</th>
                                    <th class="width30per">Designation</th>
                                </tr>
                            </table>
                        </div>
                    </div>
